...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        #values=spacex_df.groupby(['Launch Site']).sum()['class'], 
        values='class',
        names='Launch Site', 
        ...
        #filter the data and count success
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        filtered_df = filtered_df.groupby(['Launch Site','class']).size().reset_index(name='class count')
        # return the outcomes piechart for a selected site
        fig=px.pie(filtered_df,
        values=filtered_df['class count'],
...
def get_scatter_plot(site, payload):
    #filter data accordingly to payload selected
    ...
    if site=='ALL':
        ...
        filter_site_df = filter_df[filter_df['Launch Site'] == site]
        fig = px.scatter(filter_site_df,
            x='Payload Mass (kg)',
            y='class',
            color='Booster Version Category',
            title="Payload mass vs Success for site " + site
        )
        return fig
